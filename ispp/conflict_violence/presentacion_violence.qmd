...
## About me: Matías Deneken

-   I am a sociologist, with an M.A. in Sociology and currently finishing an M.A. in Data Science. I work as a research assistant at the Observatorio de Violencia y Legitimidad Social (OLES).

-   Previously, I was a researcher at the Quantitative Studies Unit of the Center for Intercultural and Indigenous Studies (CIIR).

-   Currently, I am a Fulbright Fellow and plan to start my PhD in the U.S. in 2027 — if the scholarship still exists by then! 😆
...
[Gerber et al. 2023]{style="color:#1f77b4;"}. examine attitudes toward violence perpetrated by and against protesters in Chile. This project builds on their methodological approach, but applies it to the conflict between the Chilean state and the Mapuche people, using a broader temporal window and focusing exclusively on Indigenous populations.
