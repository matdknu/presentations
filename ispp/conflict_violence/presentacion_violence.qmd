...
![](images/carabinero-agradedido.jpg){fig-align="center" width="502"}

## Introduction

### Context: Ethnic Conflict and Social Mobilization in Chile

-   The 2019 social uprising further amplified demands for justice and equality, bringing Mapuche claims into broader social movements and framing them as part of a collective struggle against systemic injustice.\
-   However, the 2022 plebiscite marked a political turning point: despite symbolic inclusion in the Constitutional Convention's proposal for a plurinational state, the rejection of the draft constitution revealed limited societal consensus around Indigenous autonomy.

![](images/estallido-social2.jpg){fig-align="center"}
...
-   **Contact Theory**: Posits that intergroup contact under favorable conditions (e.g., equal status, cooperation, institutional support) can reduce prejudice and intergroup hostility (Allport, 1954). Applied here to assess how the quality of contact with Indigenous peoples affects support for violence.
-   **Social Identity Theory**: Suggests that individuals derive part of their identity from group membership, leading to in-group favoritism and potential out-group discrimination (Tajfel & Turner, 1979). Relevant for understanding how ethnic identification shapes attitudes toward intergroup conflict.
-   **Procedural Justice Theory**: Emphasizes the importance of fair and respectful treatment by authorities in fostering legitimacy and compliance (Tyler, 2006). In the intercultural context, perceptions of procedural fairness may influence whether violence by or against the state is seen as justified.
...
For this research we used: Indigenous and non indigeneous.
...
| Carabineros treat non-Indigenous people with respect | Perceived fairness in police treatment of non-Indigenous           | Procedural justice; institutional trust        | Tyler (2006); Sunshine & Tyler (2003); Lind & Tyler (1988)                    |
:::
